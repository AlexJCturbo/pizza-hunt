...
/*We'll get all pizza data transformed into JSON data that we can better
use. Then we display each one through the printPizza function using the .forEach() method.*/
const getPizzaList = () => {
  fetch('/api/pizzas')
